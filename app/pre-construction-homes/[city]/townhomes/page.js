...
export async function generateMetadata({ params }, parent) {
  ...
  return {
    ...
    description: `${city} upcoming pre construction Townhomes. Check out ${data.preconstructions.length}+ new construction townhomes on Monk Nest. Floor plans & pricing updated for upcoming new construction townhomes in ${city}`,
  };
}
