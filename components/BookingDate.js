          ...
          <div className="max-w-[300px]">
            ...
            <div className="relative mb-3">
              <input
                ...
                required={true}
                className="rounded-pill bg-white mt-4 fff w-full px-4 pt-5 pb-1 border-b-2 focus:outline-none peer/phone placeholder:translate-y-1/2 placeholder:scale-100"
              />
              <label
                htmlFor="phone"
