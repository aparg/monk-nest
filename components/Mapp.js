  ...
  return (
    <>
      ...
      >
        ...
        {selected && (
          <Link
            href={`/${selected.city.name.toLowerCase()}/${selected.slug}/`}
            className="mylinkk shadow-lg"
            target="_blank"
          >
            <Popup
            ...
            >
              <div className="mycard">
                ...
                <div className="card-body">
                  <p className="card-title fs-mine">{selected.project_name}</p>
